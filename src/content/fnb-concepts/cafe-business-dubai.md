...
checklist:
  - "Validate footfall on the specific street/mall floor, not just the area"
  - "Stress-test the rent at 60% of break-even, not 100%"
  - "Decide single-store profitable vs scalable from day one"
  - "Pick a category position: specialty, social, productivity, or hybrid — don't try to be all four"
  - "Lock the menu around 6-8 hero items before adding breadth"
  - "Build the delivery P&L separately with aggregator commission baked in"
  - "Set the brand voice before the visual identity — it's harder to retrofit"
...
relatedPages:
  ...
  - title: "UAE Market Intelligence"
    ...
    eyebrow: "Country"
  - title: "Restaurant Finance Hub"
    href: "/restaurant-finance/"
    eyebrow: "Finance"
  - title: "Why Most Rebrands Fail"
    href: "/thinking/why-most-rebrands-fail/"
    eyebrow: "Thinking"
faqs:
